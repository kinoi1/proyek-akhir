            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php
echo form_open('pengajuan/dynamic_form/save_detail', "enctype='multipart/form-data' id='edit_user'");
?>
                            ...
                            <div class="form-group col-lg-12 mb-2">
                                <div id="dynamic_field">
                                    <div class="row" id="first_row">
                                        ...
                                        <div class="form-group col-lg-4">
                                            <input type="email" name="nominal" class="form-control" maxlength="35"
...
$(document).ready(function() {
    ...
    $('#btn_add_license').click(function() {
        ...
        $('#dynamic_field').append(
            ...
            '" > <div class="form-group col-lg-4"> <input type="text" class=" form-control" name="nama_akun' +
            i +
            '" placeholder="Enter name" maxlength="35" class="form-control name_list" aria-required="true" /> </div><div class="form-group col-lg-4"> <input type="nominal" class="form-control" name="vEmail' +
            i +
